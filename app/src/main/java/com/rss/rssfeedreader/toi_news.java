...
public class toi_news extends AppCompatActivity {
    ...
    {
        ProgressDialog progressDialog = new ProgressDialog(toi_news.this);
        ...
        protected Exception doInBackground(Integer... params) {
            ...
            try
            {
                URL url = new URL("https://timesofindia.indiatimes.com/rssfeeds/-2128936835.cms");
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(toi_news.this, android.R.layout.simple_list_item_1, Full);
