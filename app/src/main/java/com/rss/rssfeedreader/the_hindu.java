...
public class the_hindu extends AppCompatActivity {
    ...
    {
        ProgressDialog progressDialog = new ProgressDialog(the_hindu.this);
        ...
        protected Exception doInBackground(Integer... params) {
            ...
            try
            {
                URL url = new URL("https://www.thehindu.com/news/national/?service=rss");
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(the_hindu.this, android.R.layout.simple_list_item_1, Full);
